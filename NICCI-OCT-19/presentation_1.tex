...
\author[Arun and Markus]{ %\\ \&
 } % Your name
\institute[] % Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
Rolf Findeisen (Otto von Guericke University Magdeburg) \\
Holger Karl (University of Paderborn) \\ % Your institution for the title page
...
\end{columns}
\begin{itemize}
 \item Broad Goal: Holistic control of large-scale, modular, distributed systems.
